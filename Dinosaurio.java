...
/**
 * Dinosaurio Se simula el movimiento de los objetos. Además de simular movimiento se verifíca el contacto con el personaje principal<br>
 ...
 * @version 30/01/2017
 */
public class Dinosaurio extends Enemigo
{
    /**
     * Dinosaurio Se inicializa objeto Dinosaurio (propiedades).
     */
     public Dinosaurio(){
         velocidad=-1;
     ...
     * se le asiga la vida de 1. (Esto para enseguida ser removido).
     */
